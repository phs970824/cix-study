...
const DetailMovie = () => {
    ...
    return (
        <div className="detail-movie">
            <strong className="title">함께 시청된 콘텐츠</strong>
            <ul className="list">
                {contentsList.map((item) => {
                    return (
                        <li key={item.id}>
                            <OpenDetailModal id={Number(item.id)}>
                                <div className="i-box">
                                    <Image
                                        src={item.thumbnail}
                                        alt={item.title}
                                ...
                                <div className="t-box">
                                    ...
                                    <p className="story">
                                        이것은 날 만든 인간에 대한 역습이다!
                                        최강의 포켓몬을 연구하던 과학자들에 의해
                                        태어난 뮤츠의 복수 선언. 과연 지우와
                                        피카츄 일행은 이 강적을 막아낼 수 있을
                                        것인가?
                                    </p>
                                </div>
                            </OpenDetailModal>
