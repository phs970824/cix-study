        ...
        <AnimatePresence>
            {isOpen && data && (
                <motion.div
                    ...
                    <div className={`simple-modal-container ${isFirst ? 'first' : ''} ${isLast ? 'last' : ''}`}>
                        <div className="i-box">
                            <Image
                        ...
                        <div className="t-wrap">
                            ...
                            <ul className="flex keywords">
                                {data.keywords &&
                                    data.keywords.map((keyword: { id: number; name: string }) => <li key={keyword.id}>{keyword.name}</li>)}
                            </ul>
                        </div>
                    </div>
                </motion.div>
