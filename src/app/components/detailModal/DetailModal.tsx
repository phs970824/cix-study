...
const DetailModal = ({ data }: { data: DetailModalProps | null }) => {
    ...
    //     backdrop_path: mockData.heroCont.image,
    //     videoURL: 'VXKHys7odj8',
    //     adult: false,
    //     runtime: '1시간 40분',
    //     release_date: '2025',
    //     overview:
                    ...
                    <>
                        <section className="kv">
                            <div className="kv__thumb">
                                ...
                                />
                                {/* <YouTubeEmbed embedId={data.videoURL} /> */}
                            </div>
                            <div className="kv__info-box">
                                <h2 className="kv__title">{data.title}</h2>
                                <div className="kv__b-box">
                                    <IconTextButton
                                        text="재생"
                                        className="kv__play"
                                        icon={
